...
using SchoolERP.Communication.Repositories;
using SchoolERP.Communication.Repositories.Interfaces;
using SchoolERP.Communication.Services;
...
builder.Services.AddStackExchangeRedisCache(options =>
{
    ...
    options.InstanceName = "communication:";
});

builder.Services.AddScoped<IAnnouncementRepository, AnnouncementRepository>();
builder.Services.AddScoped<IParentMessageRepository, ParentMessageRepository>();
builder.Services.AddScoped<IAnnouncementService, AnnouncementService>();
builder.Services.AddScoped<IParentMessageService, ParentMessageService>();
...
{
    c.SwaggerDoc("v1", new() { Title = "SchoolERP Communication.API", Version = "v1" });

...
builder.Services.AddStackExchangeRedisCache(options =>
{
    ...
    options.InstanceName = "transport:";
});

builder.Services.AddScoped<IRouteRepository, RouteRepository>();
builder.Services.AddScoped<IVehicleRepository, VehicleRepository>();
builder.Services.AddScoped<IStudentRouteMappingRepository, StudentRouteMappingRepository>();
...
{
    c.SwaggerDoc("v1", new() { Title = "SchoolERP Transport.API", Version = "v1" });

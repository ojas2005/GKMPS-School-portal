...
/// <summary>
/// Teacher/staff profile. LinkedUserId points back to the account in Identity.API.
...
public class StaffProfile : BaseEntity
{
    ...
    public string? SubjectsTaughtCsv { get; set; }      // simple CSV of subject codes; Academic.API owns the authoritative allocation
    ...
    /// Only the class teacher of class X may upload class X's attendance; Identity.API embeds

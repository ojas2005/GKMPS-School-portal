...
using SchoolERP.Attendance.Repositories;
using SchoolERP.Attendance.Repositories.Interfaces;
using SchoolERP.Attendance.Services;
using SchoolERP.Attendance.Services.Interfaces;
...
builder.Services.AddStackExchangeRedisCache(options =>
{
    ...
    options.InstanceName = "attendance:";
});

builder.Services.AddScoped<IAttendanceRepository, AttendanceRepository>();
builder.Services.AddScoped<IMonthlyAttendanceSummaryRepository, MonthlyAttendanceSummaryRepository>();
...
builder.Services.AddRateLimiter(options =>
{
    ...
    options.GlobalLimiter = System.Threading.RateLimiting.PartitionedRateLimiter.Create<HttpContext, string>(httpContext =>
        System.Threading.RateLimiting.RateLimitPartition.GetFixedWindowLimiter(
            ...
            {
                PermitLimit = 300, // this service is a documented peak-load / HPA target
...
{
    c.SwaggerDoc("v1", new() { Title = "SchoolERP Attendance.API", Version = "v1" });

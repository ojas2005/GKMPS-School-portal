...
using SchoolERP.Notification.Repositories;
using SchoolERP.Notification.Repositories.Interfaces;
using SchoolERP.Notification.Services;
...
// them out to email/SMS/push via IDispatchService.
builder.Services.AddMassTransit(x =>
{
    x.AddConsumer<UserRegisteredConsumer>();
    x.AddConsumer<StudentEnrolledConsumer>();
    x.AddConsumer<FeePaidConsumer>();
...
{
    c.SwaggerDoc("v1", new() { Title = "SchoolERP Notification.API", Version = "v1" });

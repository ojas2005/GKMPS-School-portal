...
public class TokenGenerator : ITokenGenerator
{
    ...
    public string GenerateAccessToken(User user, StudentProfile? studentProfile = null, StaffClaimsProfile? staffProfile = null)
    {
        ...
        {
            claims.Add(new Claim(SchoolERP.Shared.Common.CallerClaims.StudentIdClaim, studentProfile.StudentId.ToString()));
            claims.Add(new Claim(SchoolERP.Shared.Common.CallerClaims.ClassIdClaim, studentProfile.ClassId));
            claims.Add(new Claim(SchoolERP.Shared.Common.CallerClaims.SectionIdClaim, studentProfile.SectionId));
        }
        ...
        {
            claims.Add(new Claim(SchoolERP.Shared.Common.CallerClaims.StaffIdClaim, staffProfile.StaffId.ToString()));
            if (!string.IsNullOrEmpty(staffProfile.ClassTeacherOfClassId))
                claims.Add(new Claim(SchoolERP.Shared.Common.CallerClaims.ClassTeacherOfClassIdClaim, staffProfile.ClassTeacherOfClassId));
            if (!string.IsNullOrEmpty(staffProfile.ClassTeacherOfSectionId))
                claims.Add(new Claim(SchoolERP.Shared.Common.CallerClaims.ClassTeacherOfSectionIdClaim, staffProfile.ClassTeacherOfSectionId));
        }

...
namespace SchoolERP.Shared.ExceptionHandling;

/// <summary>
/// Catches whatever a controller's own try/catch didn't anticipate. Registered once per
/// service via <see cref="ServiceCollectionExtensions.AddSharedExceptionHandling"/> +
/// <c>app.UseExceptionHandler()</c> in Program.cs, so every service fails the same way:

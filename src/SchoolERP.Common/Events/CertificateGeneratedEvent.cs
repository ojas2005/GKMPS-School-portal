...
/// ID card) is generated and uploaded to Blob Storage. Handled by the Notification module
/// to alert the recipient, carrying only the verification code -- never the raw SAS URL --
